 ...
 * @property {object} [metaKeyBounds={}] - Key marker configuration used to match the meta key.
 * @property {string} [metaKeyBounds.left='{{ '] - Left bound of the meta key marker.
 * @property {string} [metaKeyBounds.right=' }}'] - Right bound of the meta key marker.
...
function plugin(opts = {}) {
    ...
    opts.metaKeyBounds = _setArgDefaults(opts.metaKeyBounds, Object, Object, {});
    opts.metaKeyBounds.left = _setArgDefaults(opts.metaKeyBounds.left, String, String, '{{ ');
    opts.metaKeyBounds.right = _setArgDefaults(opts.metaKeyBounds.right, String, String, ' }}');
