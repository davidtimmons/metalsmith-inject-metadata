 ...
 */
function _injectNestedFileObject(fileValueObject, transformText = t => t) {
    Object.keys(fileValueObject).forEach((fileKey) => {
        ...
        if (typeof fileValue === 'object' && isNotArray) {
            ...
            fileValueObject[fileKey] = fileValue.map((value) => {
                if (_canHaveKeys(value)) {
                    _injectNestedFileObject(value, transformText);
                    return value;
                }
