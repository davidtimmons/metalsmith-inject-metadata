 ...
 */
function injectFile(fileData, fileKey, metadata, metaKey, metaKeyBounds) {
    ...
    if (typeof fileValue === 'string') {
        ...
        fileData[fileKey] = fileValue.map((value, i) => {
            if (typeof value === 'string') {
                ...
                Object.keys(value).forEach((valueKey) => {
                    injectFile(value, valueKey, metadata, metaKey, metaKeyBounds);
                });
                return value;
            }
        ...
        Object.keys(fileValue).forEach((fileValueKey) => {
            injectFile(fileValue, fileValueKey, metadata, metaKey, metaKeyBounds);
        });
    }
}
